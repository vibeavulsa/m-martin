...
const defaultCushionKit = {
  ...
  product: {
    ...
    description: 'Kit com 5 refis em tecido Oxford, fibra siliconada 500g e capas em Camurça Importada. Escolha as cores de cada uma!',
    price: 'R$ 48,00',
    priceInstallment: 'R$ 53,90',
    installments: 5,
    priceCash: 'R$ 48,00',
    image: 'https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?w=600',
    features: ['Kit com 5 unidades', 'Refil em tecido Oxford', 'Capas em Camurça Importada', 'Fibra siliconada 500g', 'Cores variadas'],
    isKit: true,
    kitQuantity: 5,
  },
};
